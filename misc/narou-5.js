		...
		push(date){
				this.favorites.push(
				{
						...
						// section: obj.subtitle.textContent,
						    ...
						    url: normalizeURL(location.href).split('/').slice(0, -2).join('/'),
				});
		}
		...
		try{
				...
				document.body.iahAB(
						'' +
								...
								'  <ce-container slot="container">' +
								'    <ce-inner-buttons-area slot="inner-buttons">' +
								'    </ce-inner-buttons-area>' +
								'    <slot slot="inner">hahaha</slot>' +
								'  </ce-container>' +
								'</ce-container-container>');
